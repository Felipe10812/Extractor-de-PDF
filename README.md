...
Este proyecto no habría sido posible sin el trabajo de la comunidad de código abierto.

### Desarrollador Original

Esta aplicación es una versión mejorada y extendida basada en el excelente trabajo del proyecto original creado por **andromux**. Su código base fue la inspiración y el punto de partida para todas las funcionalidades avanzadas que se han añadido.

-   **andromux** - Creador del proyecto original.
...
-   **Flet**: Framework para crear la interfaz de usuario multiplataforma con Python.
-   **PyMuPDF (fitz)**: Para el renderizado de alta calidad de las páginas PDF a imágenes.
-   **PyPDF**: Para la manipulación y escritura de archivos PDF.
-   **Pillow**: Para el procesamiento de imágenes.
-   **Plyer**: Para las notificaciones nativas del sistema.
